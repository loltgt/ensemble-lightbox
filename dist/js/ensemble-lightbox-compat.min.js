...
/*!
   ...
   * @license MIT License
   */
t.Modal=E;var S=function(t){n(o,t);var i=r(o);function o(){return d(this,o),i.apply(this,arguments)}return y(o,[{key:"_defaults",value:function(){return l(e(s(o.prototype),"_defaults",this).call(this),{selector:"",contents:null,navigation:!0,captioned:!0,infinite:!0,autoDiscover:!0,autoHide:"navigation",overlayed:!1,checkOrigin:!0,prev:{onclick:this.prev,innerText:"<",ariaLabel:"Previous"},next:{onclick:this.next,innerText:">",ariaLabel:"Next"},onStep:function(){},onSlide:function(){},onCaption:function(){}})}},{key:"_bindings",value:function(){e(s(o.prototype),"_bindings",this).call(this),this.add=this.binds(this.add),this.remove=this.binds(this.remove),this.prev=this.binds(this.prev),this.next=this.binds(this.next)}},{key:"generator",value:function(){var t=e(s(o.prototype),"generator",this).call(this),n=this.cnt,i=this.options,r=this.gallery=this.compo("gallery");if(n.append(r),t.classList.add(i.ns+"-lightbox"),i.navigation){var a=this.nav=this.data(!0),c=a.wrap=this.compo("nav"),u=a.prev=this.compo("button","prev",i.prev),l=a.next=this.compo("button","next",i.next);c.append(u),c.append(l)}if(i.captioned){var h=this.captions=this.data(!0);h.wrap=this.compo("captions")}if(i.overlayed){var f=i.overlayed.toString().match(/captions|navigation/);t.classList.add(i.ns+"-overlayed"),f&&t.classList.add(i.ns+"-overlayed-"+overlayed[0])}if(i.autoHide){var p=i.autoHide.toString().match(/captions|navigation/);t.classList.add(i.ns+"-autohide"),p&&t.classList.add(i.ns+"-autohide-"+p[0])}i.windowed?(i.navigation&&n.append(a.wrap),i.captioned&&n.append(h.wrap)):(i.navigation&&t.append(a.wrap),i.captioned&&t.append(h.wrap))}},{key:"populate",value:function(t){console.log("populate",t);var e,n=this.options;n.contents&&"object"==p(n.contents)?e=n.contents:n.selector&&(e=this.selector(n.selector,this.element,!0));var i,r=h(e=this.contents=this.prepare(e));try{for(r.s();!(i=r.n()).done;){var o=i.value,s=this.content(o);t&&t===s.ref&&(this.index=e.indexOf(s),this.current=s),this.add(s)}}catch(t){r.e(t)}finally{r.f()}this.current=this.current||e[0],this.index=this.index||0,this.slide(0),n.navigation&&this.navigation(),n.captioned&&this.caption()}},{key:"resume",value:function(t){console.log("resume",t);var e,n=this.options,i=this.contents,r=h(i);try{for(r.s();!(e=r.n()).done;){var o=e.value;o.wrap.hide(),t&&t===o.ref&&(this.index=i.indexOf(o),this.current=o)}}catch(t){r.e(t)}finally{r.f()}this.current=this.current||i[0],this.index=this.index||0,this.slide(0),n.navigation&&this.navigation(),n.captioned&&this.caption()}},{key:"content",value:function(t,e){var n,i=this.options,r=this.compo("object");r.hide();var o=(n="string"==typeof t?this.data({src:t}):t).src,s=n.type;s&&(s=(s=s.match(/(^image|video|audio)|(pdf$)/))?s[0]:"");var a,c=/^https?:\/\//.test(o),u=!1;(i.autoDiscover&&o&&!s&&(/\.jpg|\.jpeg|\.png|\.apng|\.gif|\.webp|\.avif|\.bmp|\.svg$/i.test(o)?s="image":/\.pdf$/.test(o)?s="pdf":/\.mp4|\.webm|\.ogv|\.m4v|\.hevc|\.ivf|\.obu|\.ismv|\.mkv$/i.test(o)?s="video":/\.mp3|\.opus|\.ogg|\.m4a|\.aac|\.flac|\.wav|\.weba|\.mka$/i.test(o)?s="audio":/^data:image\/jpeg|png|apng|gif|webp|avif|bmp|svg\+xml/.test(o)&&(u=!0,s="image")),"pdf"===s&&(s="iframe",a="pdf"),i.checkOrigin&&o&&c&&!u)&&(("null"!=window.origin?window.origin:window.location.origin)!=new URL(o).origin&&(s=""));if(o&&!s)if("#"===o[0]){var l=this.selector(o);l&&(n.node=l,s=/iframe|img|picture|video|audio/i.test(l.nodeName)?/img|picture/i.test(l.nodeName)?"image":l.nodeName.toLowerCase():"element")}else s="iframe";"element"===s&&(e=void 0!==e?e:i.cloning,n.node=e?this.cloneNode(n.node,!0):n.node),n.ref=n.ref||null,n.type=s,n.src=o,i.onContent.call(this,this,n),s&&r.classList.add(i.ns+"-"+s),a&&r.classList.add(i.ns+"-"+a);var h=this.inner(n);return n.fresh=function(){n.node&&n.inner.inject(n.node),n.wrap.show()},n.stale=function(){n.node&&n.inner.empty(),n.wrap.hide()},n.wrap=r,n.inner=n.compo(h.tag,h.name,h.props,!0,n.fresh,n.stale),n}},{key:"inner",value:function(t){var e=t.type,n=!0,i={};for(var r in t)/ref|src|type|sources|subtitles|children/.test(r)||"_"==r[0]||(i[r]=t[r]);switch(t.src&&(i.src=t.src),t.type){case"image":if(e="img",t.sources||t.children)if(e="picture",i.children=[],t.sources&&"object"==p(t.source)){var o,s=h(t.sources);try{for(s.s();!(o=s.n()).done;){var a=o.value;i.children.push({tag:"source",name:!0,props:a})}}catch(t){s.e(t)}finally{s.f()}}else if(t.children&&t.children.length){var c,u=h(t.children);try{for(u.s();!(c=u.n()).done;){var l=c.value,f=l.tagName.toLowerCase();"source"==f&&"img"==f&&i.children.push({tag:f,name:!0,props:l.attributes})}}catch(t){u.e(t)}finally{u.f()}}break;case"video":case"audio":if(i.controls=!t.controls||t.controls,i.children=[],t.sources&&"object"==p(t.sources)){var d,v=h(t.sources);try{for(v.s();!(d=v.n()).done;){var y=d.value;i.children.push({tag:"source",name:!0,props:y})}}catch(t){v.e(t)}finally{v.f()}if(t.subtitles&&"object"==p(t.subtitles)){var m,g=h(t.subtitles);try{for(g.s();!(m=g.n()).done;){var b=m.value;i.children.push({tag:"track",name:!0,props:b})}}catch(t){g.e(t)}finally{g.f()}}}else if(t.children&&t.children.length){var w,k=h(t.children);try{for(k.s();!(w=k.n()).done;){var _=w.value,x=_.tagName.toLowerCase();"source"==x&&"track"==x&&i.children.push({tag:x,name:!0,props:_.attributes})}}catch(t){k.e(t)}finally{k.f()}}break;case"iframe":if(i.frameBorder=0,!i.src)return null;break;default:e="div",n="custom-element"}return{tag:e,name:n,props:i}}},{key:"prepare",value:function(t){var e=[];if(t&&"object"==p(t)&&t.length){var n,i=h(t);try{for(i.s();!(n=i.n()).done;){var r=n.value;if("object"==p(r)&&"nodeName"in r){var o=this.data(!0),s=r.dataset;if(l(o,s),o.ref=r,s.sources)try{o.sources=JSON.parse(s.sources)}catch(t){}if(r.href)o.src=r.href;else if(s.href)o.src=s.href;else if(/iframe|img|picture|video|audio/i.test(r.nodeName)){var a=r.nodeName.toLowerCase();/img|picture/.test(a)?o.type="image":o.type=a,"iframe"!=a&&r.children&&r.children.length&&(o.children=r.children)}else o.type="element",o.node=r;s.caption&&(o.caption=s.caption),e.push(o)}else"string"==typeof r?e.push(r):"type"in r&&/(^element|iframe|image|video|audio|pdf)/.test(r.type)?e.push(this.data(r)):e.push(this.data(!0))}}catch(t){i.e(t)}finally{i.f()}}return e}},{key:"add",value:function(t){this.gallery.append(t.wrap),this.options.navigation&&this.navigation()}},{key:"remove",value:function(t){this.gallery.remove(t.wrap),this.options.navigation&&this.navigation()}},{key:"prev",value:function(t){this.event(t),this.slide(-1)}},{key:"next",value:function(t){this.event(t),this.slide(1)}},{key:"slide",value:function(t){var e=this.options;if(e.infinite||0==this.way||this.way!==t){var n=this.contents,i=this.index,r=this.current,o=r;if(e.onStep.call(this,this,r,t),0!=t){var s=n.length-1,a=-1===t?n[i-1]:n[i+1],c=-1===t?n[s]:n[0];o=a||c,i=a?-1===t?i-1:i+1:-1===t?s:0,r.stale("inner")}if(!e.infinite){var u=0;o.wrap.previous?o.wrap.next||(u=1):u=-1,this.way=parseInt(u),e.navigation&&this.navigation(u)}o.render("inner"),o.wrap.append(o.inner),e.onSlide.call(this,this,r,t,r.wrap!=o.wrap?o.wrap:null),this.delay((function(){0!=t&&r.wrap.remove(r.inner)}),r.wrap),this.index=i,this.current=n[i],e.captioned&&this.caption()}}},{key:"navigation",value:function(t){var e=this.nav;if(this.contents.length>1){if(e.wrap.show(),!this.options.infinite&&void 0!==t)switch(t){case-1:e.prev.disable(),e.next.enable();break;case 1:e.prev.enable(),e.next.disable();break;default:e.prev.enable(),e.next.enable()}}else e.wrap.hide()}},{key:"caption",value:function(t){var e=this.options,n=this.captions,i=this.current;if(n.wrap.empty(),!e.onCaption(this,this,i,t)){if(!t)if(i.caption)t=i.caption;else if(e.selector){var r=i.ref;if(this.hasAttr(r,"title"))t=this.getAttr(r,"title");else if("image"===i.type){t=this.selector("img",r).alt}}if(t){var o,s=h(t=t.split(/\n\n|\r\n\r\n/));try{for(s.s();!(o=s.n()).done;){var a=o.value,c=this.compo("p",!0,{innerText:a});n.wrap.append(c)}}catch(t){s.e(t)}finally{s.f()}}}}},{key:"keyboard",value:function(t){switch(e(s(o.prototype),"keyboard",this).call(this,t),t.keyCode||0){case 37:this.prev(t);break;case 39:this.next(t)}}}]),o}(E);t.Lightbox=S}));