...
Y_MIN = 0; Y_MAX = 1;
TIME_INCREMENT = -0.09;
// TIME_INCREMENT = 1; // export
OUT_PAUSE = false;
// OUT_PAUSE = true; // export
...
color rgb(x, y, t) {
  ...
  int value = sin(xx * 600) + cos(yy / 20);
  int luma = color(u + v + 1 / value * 1000, u + v + 1 / value * 1000, u + v + 1 / value * 1000);

  return color(-luma * 22, -luma / 100000 / 3.75, 6);
}
